...
UdpClient::UdpClient(int & argc, char** argv) : QCoreApplication(argc,argv)
{
...
void UdpClient::slotSendWheelspeed()
{
...
void UdpClient::slotStateChanged(QAbstractSocket::SocketState state)
{
